  ...
  return (
    <div className="px-5 max-w-screen-sm lg:rounded-lg lg:border lg:border-white-2 m-auto lg:mt-6 lg:p-8 lg:pt-0">
      <div className="flex flex-col items-center font-poppins w-full">
        ...
        <button
          onClick={handleGuest}
          className="bg-red-600 flex items-center justify-center text-white py-3 my-2 w-full cursor-pointer transition-all hover:bg-opacity-90 rounded-md focus:opacity-90"
        >
