    ...
    <div className="font-poppins h-screen flex">
      ...
      <div className="w-full lg:w-4/5">
        ...
        <div className="text-black-2 px-5 mt-5 border-b border-white-1">
          <Link
            className="flex items-center mb-6 lg:mb-4 transition-all lg:hover:bg-white-0 rounded lg:p-2"
            to="/likedvideos"
          >
            ...
            <div className="mb-20">
              {state.playlists?.map(item => {
                return (
                  <Link
                    key={item._id}
                    className="flex items-center justify-between mb-6 lg:mb-4 text-black-2 transition-all lg:hover:bg-white-0 rounded lg:p-2"
